...
label
  ...
  licz,
  {miary,}
  {kalendarz,}          {Zakomentowane, bo nie są jako tako potrzebne}
  {przeglady,}
  kalkulator,
  oplacalno,
  koniec,
...
var
  ...
  wydaj    : Real;
  plyk     : Text;
  nazwa_pl : String; { Nie ma nic wspólnego z hostingiem Nazwa.pl }
